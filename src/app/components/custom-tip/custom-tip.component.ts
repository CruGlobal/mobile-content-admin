...
export class CustomTipComponent implements OnInit {
  ...
  constructor(private customTipService: CustomTipService,
              private draftService: DraftService,
              private activeModal: NgbActiveModal) {}

  ngOnInit(): void {
    this.draftService.getTip(this.customTip.tip, this.translation)
      .then((response) => {
  ...
  updateCustomTip(): void {
    this.customTipService.upsert(this.customTip.language.id, this.customTip.tip.id, this.customTip.structure)
