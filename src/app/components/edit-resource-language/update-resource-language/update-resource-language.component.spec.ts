...
describe('UpdateResourceLanguageComponent', () => {
  ...
  beforeEach(() => {
    spyOn(resourceLanguageServiceStub, 'update').and.returnValue(Promise.resolve<ResourceLanguage>(null));

    TestBed.configureTestingModule({
      declarations: [ UpdateResourceLanguageComponent, XmlEditorComponent, AceEditorDirective ],
      imports: [ NgbModule.forRoot(), FormsModule ],
      providers: [
        {provide: ResourceLanguageService, useValue: resourceLanguageServiceStub},
  ...
  it('updates resource when clicking on save button', () => {
    ...
    expect(resourceLanguageServiceStub.update).toHaveBeenCalledWith(resourceLanguage);
  });
});
