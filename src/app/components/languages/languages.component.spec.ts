...
describe('LanguagesComponent', () => {
  ...
  beforeEach(async(() => {
    const languageServiceStub = {
      ...
      getLanguages() { return Promise.resolve( [new Language()] ); }
    };
  ...
  it('should show success alert after successfully deleting a language', (done) => {
    ...
    setTimeout(() => {
      ...
      const elements: DebugElement[] = fixture.debugElement.queryAll(By.directive(NgbAlert));
      const successAlert = elements.find(e => e.attributes.type === 'success');
